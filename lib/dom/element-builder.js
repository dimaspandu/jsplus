...
(function (global) {
  ...
  ElementBuilder.prototype.onViewport = function ()
  {
    return (this.node.getBoundingClientRect().bottom - this.node.clientHeight) <= (window.innerHeight || document.documentElement.clientHeight);
  };
