 ...
 */
 ...
 (function (global) {
  ...
  StatefulComponent.prototype.build = function (callback)
  {
    ...
    this.component = callback(root.state,
      function (newState) {
        root.setState(newState);
        return;
      },
      function (callback) {
        root.setStateEffect(callback);
        return;
      }
    );
  ...
  StatefulComponent.prototype.setState = function (newState)
  {
    var root = this;
  
    Object.keys(newState).forEach(function (stateKey) {
      root.state[stateKey] = newState[stateKey];
    });
  ...
  StatefulComponent.prototype.setStateEffect = function (callback)
  {
    var root = this;
